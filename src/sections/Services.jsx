...
import payment from '../assets/assets/payment.png'
import shipping from '../assets/assets/shipping.png'
import refund from '../assets/assets/return.png'
...
export const Services = () => {
  ...
  return (
    <div id='category'  className='w-full lg:px-20 px-5 pt-[0px] pb-[80px] grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10'>
