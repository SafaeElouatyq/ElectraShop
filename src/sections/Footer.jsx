...
import client4 from '../assets/assets/client4.png'
import client5 from '../assets/assets/client5.png'
import client6 from '../assets/assets/client6.png'
      ...
      <div className='w-full lg:px-20 px-5 py-[60px] bg-gray-100 grid lg:grid-cols-[,auto,auto,auto,auto,auto] grid-cols-1 justify-between items-start lg:gap-3 gap-10'>
        <div data-aos="zoom-in" data-aos-delay="100" className="flex flex-col justify-center items-start gap-10 grow">
          <div className="flex flex-col justify-center items-start gap-4">
            ...
            <p className='text-gray-500 text-justify'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. <br/>Debitis aut eaque repellat vero praesentium ex laborum <br/>suscipit. Libero unde officiis vero cupiditate delectus<br/> laborum hic eius, neque, repellat, aut nisi.</p>
          </div>
          <div className="flex flex-col justify-center items-start gap-4">
