...
import headset from '../assets/assets/headset.jpg'
import earbuds from '../assets/assets/earbuds.jpg'
import dslr from '../assets/assets/dslr.jpg'
import AOS from 'aos';
      ...
      <Slider className='w-full' {...settings} >
        <div>
          <div className="w-full lg:px-20 px-5 lg:h-[700px] h-[600px] flex flex-col justify-center items-start gap-10 bg-cover bg-center" style={{backgroundImage:`url(${dslr})`}}>
            ...
            <h1 data-aos="zoom-in" data-aos-delay="100" className='text-white lg:text-[120px] text[60px]uppercase font-bold lg:leading-[120px] leading-[70px]'>DSLER 360 <br></br> Camera</h1>
